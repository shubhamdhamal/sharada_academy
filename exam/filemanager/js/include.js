...
!(function (y, n, a) {
        ...
        s = {
            contextActions: {
                ...
                unzip: function (e) {
                    ...
                    show_animation(),
                        y.ajax({ type: "POST", url: "ajax_calls.php?action=extract", data: { path: a } }).done(function (e) {
                ...
                edit_img: function (e) {
                    ...
                    n.attr("data-name", a),
                        ...
                        imageEditor
                            ...
                            .then(function (e) {
                                imageEditor.ui.resizeEditor({ imageSize: { oldWidth: e.oldWidth, oldHeight: e.oldHeight, newWidth: e.newWidth, newHeight: e.newHeight } });
                            })
                            .catch(function (e) {
                ...
                select: function (e) {
                    ...
                    (1 == jQuery("#return_relative_url").val() && (t = (t = t.replace(jQuery("#base_url").val(), "")).replace(jQuery("#cur_dir").val(), "")), (a = 1 == jQuery("#popup").val() ? window.opener : window.parent), "" != r)
                        ? 1 == jQuery("#crossdomain").val()
                            ? a.postMessage({ sender: "responsivefilemanager", url: t, field_id: r }, "*")
                            : (jQuery("#" + r, a.document)
                                  .val(t)
                                  .trigger("change"),
                              "function" == typeof a.responsive_filemanager_callback && a.responsive_filemanager_callback(r),
                              j())
                        : apply_any(t);
                },
                copy: function (e) {
                            ...
                            bootbox.dialog(
                                ...
                                [
                                    { label: jQuery("#cancel").val(), class: "btn" },
                                    {
                                        ...
                                        callback: function () {
                                            var a = "-";
                                            jQuery("#u_4").is(":checked") ? (a += "r") : (a += "-"),
                                                jQuery("#u_2").is(":checked") ? (a += "w") : (a += "-"),
                                                jQuery("#u_1").is(":checked") ? (a += "x") : (a += "-"),
                                                jQuery("#g_4").is(":checked") ? (a += "r") : (a += "-"),
                                                jQuery("#g_2").is(":checked") ? (a += "w") : (a += "-"),
                                                jQuery("#g_1").is(":checked") ? (a += "x") : (a += "-"),
                                                jQuery("#a_4").is(":checked") ? (a += "r") : (a += "-"),
                                                jQuery("#a_2").is(":checked") ? (a += "w") : (a += "-"),
                                                jQuery("#a_1").is(":checked") ? (a += "x") : (a += "-");
                                            var e = jQuery("#chmod_form #chmod_value").val();
                                            if ("" != e && void 0 !== e) {
                                                var t = jQuery("#chmod_form input[name=apply_recursive]:checked").val();
                                                ("" != t && void 0 !== t) || (t = "none"),
                                                    y.ajax({ type: "POST", url: "execute.php?action=chmod", data: { path: i, new_mode: e, is_recursive: t, folder: n } }).done(function (e) {
                                ...
                                [
                                    { label: jQuery("#cancel").val(), class: "btn" },
                                    {
                                        ...
                                        callback: function () {
                                            ...
                                            window.editor && "function" == typeof window.editor.getData && (e = window.editor.getData()),
                                                y.ajax({ type: "POST", url: "execute.php?action=save_text_file", data: { path: t, new_content: e } }).done(function (e) {
                                                    "" != e && bootbox.alert(e);
                                                });
                                        },
                                    },
            ...
            makeContextMenu: function () {
                ...
                y.contextMenu({
                    ...
                    build: function (t) {
                        ...
                        return (
                            (t.find(".img-precontainer-mini .filetype").hasClass("png") || t.find(".img-precontainer-mini .filetype").hasClass("jpg") || t.find(".img-precontainer-mini .filetype").hasClass("jpeg")) &&
                                a &&
                                (e.items.edit_img = { name: jQuery("#lang_edit_image").val(), icon: "edit_img", disabled: !1 }),
                            t.hasClass("directory") && 0 != jQuery("#type_param").val() && (e.items.select = { name: jQuery("#lang_select").val(), icon: "", disabled: !1 }),
                            (e.items.copy_url = { name: jQuery("#lang_show_url").val(), icon: "url", disabled: !1 }),
                            (t.find(".img-precontainer-mini .filetype").hasClass("zip") || t.find(".img-precontainer-mini .filetype").hasClass("tar") || t.find(".img-precontainer-mini .filetype").hasClass("gz")) &&
                                1 == jQuery("#extract_files").val() &&
                                (e.items.unzip = { name: jQuery("#lang_extract").val(), icon: "extract", disabled: !1 }),
                            t.find(".img-precontainer-mini .filetype").hasClass("edit-text-file-allowed") && (e.items.edit_text_file = { name: jQuery("#lang_edit_file").val(), icon: "edit", disabled: !1 }),
                            t.hasClass("directory") || 1 != jQuery("#duplicate").val() || (e.items.duplicate = { name: jQuery("#lang_duplicate").val(), icon: "duplicate", disabled: !1 }),
                            t.hasClass("directory") || 1 != jQuery("#copy_cut_files_allowed").val()
                                ? t.hasClass("directory") &&
                                  1 == jQuery("#copy_cut_dirs_allowed").val() &&
                                  ((e.items.copy = { name: jQuery("#lang_copy").val(), icon: "copy", disabled: !1 }), (e.items.cut = { name: jQuery("#lang_cut").val(), icon: "cut", disabled: !1 }))
                                : ((e.items.copy = { name: jQuery("#lang_copy").val(), icon: "copy", disabled: !1 }), (e.items.cut = { name: jQuery("#lang_cut").val(), icon: "cut", disabled: !1 })),
                            0 == jQuery("#clipboard").val() || t.hasClass("directory") || (e.items.paste = { name: jQuery("#lang_paste_here").val(), icon: "clipboard-apply", disabled: !1 }),
                            t.hasClass("directory") || 1 != jQuery("#chmod_files_allowed").val()
                                ? t.hasClass("directory") && 1 == jQuery("#chmod_dirs_allowed").val() && (e.items.chmod = { name: jQuery("#lang_file_permission").val(), icon: "key", disabled: !1 })
                                : (e.items.chmod = { name: jQuery("#lang_file_permission").val(), icon: "key", disabled: !1 }),
                            (e.items.sep = "----"),
                            (e.items.info = { type: "html", html: "<strong>" + jQuery("#lang_file_info").val() + "</strong>" }),
                            (e.items.name = { name: t.attr("data-name"), icon: "label", disabled: !0 }),
                            "img" == t.attr("data-type") && (e.items.dimension = { name: t.find(".img-dimension").html(), icon: "dimension", disabled: !0 }),
                            ("true" !== jQuery("#show_folder_size").val() && "true" !== jQuery("#show_folder_size").val()) ||
                                (t.hasClass("directory")
                                    ? (e.items.size = {
            ...
            bindGridEvents: function () {
                ...
                e.on("click", ".modalAV", function (e) {
                    ...
                    t.removeData("modal"),
                        ...
                        a.hasClass("audio") ? r.css("height", "80px") : r.css("height", "345px"),
                        y.ajax({
                            url: a.attr("data-url"),
                            success: function (e) {
                                r.html(e);
            ...
            makeUploader: function () {
                jQuery("#fileupload").fileupload({ url: "upload.php", maxChunkSize: 2097152 }),
                    ...
                    y.ajax({ url: jQuery("#fileupload").fileupload("option", "url"), dataType: "json", context: jQuery("#fileupload")[0] }).always(function () {
            ...
            uploadURL: function () {
                jQuery("#uploadURL").on("click", function (e) {
                    ...
                    show_animation(),
                        y
                            .ajax({ type: "POST", url: "upload.php", data: { fldr: t, url: a } })
                            .done(function (e) {
            ...
            makeSort: function (r) {
                jQuery("input[name=radio-sort]").on("click", function () {
                    ...
                    (c = 0),
                        ...
                        "ff-item-type-all" == e
                            ? (r ? jQuery(".grid li").show(300) : (window.location.href = jQuery("#current_url").val() + "&sort_by=" + jQuery("#sort_by").val() + "&descending=" + (i ? 1 : 0)),
                              "undefined" != typeof Storage && localStorage.setItem("sort", ""))
                            : jQuery(this).is(":checked") &&
                              (jQuery(".grid li")
                                  .not("." + e)
                                  .hide(300),
                              jQuery(".grid li." + e).show(300),
                              "undefined" != typeof Storage && localStorage.setItem("sort", e)),
                        b();
                });
                var i = jQuery("#descending").val();
                jQuery(".sorter").on("click", function () {
                    var e = jQuery(this);
                    (i = jQuery("#sort_by").val() !== e.attr("data-sort") || 0 == i),
                        r
                            ? (y.ajax({ url: "ajax_calls.php?action=sort&sort_by=" + e.attr("data-sort") + "&descending=" + (i ? 1 : 0) }),
                              _(i, "." + e.attr("data-sort")),
                              jQuery(" a.sorter").removeClass("descending").removeClass("ascending"),
                              i ? jQuery(".sort-" + e.attr("data-sort")).addClass("descending") : jQuery(".sort-" + e.attr("data-sort")).addClass("ascending"),
                              jQuery("#sort_by").val(e.attr("data-sort")),
                              jQuery("#descending").val(i ? 1 : 0),
                              b())
                            : (window.location.href = jQuery("#current_url").val() + "&sort_by=" + e.attr("data-sort") + "&descending=" + (i ? 1 : 0));
                });
            },
        };
    function o(e) {
            ...
            (n.user = a.substr(0, 1)),
                ...
                jQuery("#chmod_form input:checkbox").each(function () {
                    ...
                    (e = n[r]),
                        ...
                        (e = parseInt(e)),
                        (a = parseInt(a)),
                        -1 != y.inArray(e, t[a]) ? jQuery(this).prop("checked", !0) : jQuery(this).prop("checked", !1);
                });
        } else
    ...
    function u(e, a) {
        ...
        ("copy" != a && "cut" != a) ||
            ...
            y.ajax({ type: "POST", url: "ajax_calls.php?action=copy_cut", data: { path: t, sub_action: a } }).done(function (e) {
    ...
    function d(t) {
        bootbox.confirm(jQuery("#lang_paste_confirm").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (e) {
            var a;
            1 == e &&
                ((a = void 0 !== t ? t.closest("figure").attr("data-path") : jQuery("#sub_folder").val() + jQuery("#fldr_value").val()),
                y.ajax({ type: "POST", url: "execute.php?action=paste_clipboard", data: { path: a } }).done(function (e) {
                    "" != e
                        ? bootbox.alert(e)
    ...
    function j() {
        1 == jQuery("#popup").val()
            ? window.close()
            : ("function" == typeof parent.jQuery(".modal:has(iframe)").modal && parent.jQuery(".modal:has(iframe)").modal("hide"),
              void 0 !== parent.jQuery && parent.jQuery
                  ? "object" == typeof parent.Fancybox
                      ? parent.Fancybox.getInstance().close()
                      : "function" == typeof parent.Fancybox && parent.Fancybox.close()
                  : "function" == typeof parent.Fancybox && parent.Fancybox.close());
    }
    function Q(e) {
        return null != e
            ? ("true" == jQuery("#transliteration").val() &&
                  (e = (e = (function (e) {
                      for (
                          var a = [/[\300-\306]/g, /[\340-\346]/g, /[\310-\313]/g, /[\350-\353]/g, /[\314-\317]/g, /[\354-\357]/g, /[\322-\330]/g, /[\362-\370]/g, /[\331-\334]/g, /[\371-\374]/g, /[\321]/g, /[\361]/g, /[\307]/g, /[\347]/g],
              ...
              "true" == jQuery("#convert_spaces").val() && (e = e.replace(/ /g, jQuery("#replace_with").val())),
    ...
    function g(e, a, t, r, i) {
        null !== t &&
            ((t = Q(t)),
            y.ajax({ type: "POST", url: "execute.php?action=" + e, data: { path: a, name: t.replace("/", "") } }).done(function (e) {
    ...
    function _(e, t) {
        ...
        a.each(function () {
            var e = jQuery(this),
                a = e.find(t).val();
            if (y.isNumeric(a)) for (a = parseFloat(a); void 0 !== i[a] && i[a]; ) a = parseFloat(parseFloat(a) + parseFloat(0.001));
            ...
            r.each(function () {
                var e = jQuery(this),
                    a = e.find(t).val();
                if (y.isNumeric(a)) for (a = parseFloat(a); void 0 !== l[a] && l[a]; ) a = parseFloat(parseFloat(a) + parseFloat(0.001));
                else a = a + "a" + e.find("h4 a").attr("data-file");
                (l[a] = e.html()), o.push(a);
            }),
            y.isNumeric(n[0])
    ...
    jQuery(document).ready(function () {
        ...
        if (
            ...
            s.bindGridEvents(),
            parseInt(jQuery("#file_number").val()) > parseInt(jQuery("#file_number_limit_js").val()))
        )
            var t = !1;
        else t = !0;
        s.makeSort(t),
                        ...
                        [
                            { label: jQuery("#cancel").val(), class: "btn" },
                            {
                                ...
                                callback: function () {
                                    ...
                                    y.ajax({ type: "POST", url: "ajax_calls.php?action=change_lang", data: { choosen_lang: a } }).done(function (e) {
                                        "" != e
                                            ? bootbox.alert(e)
                                            : setTimeout(function () {
            ...
            jQuery(".create-file-btn").on("click", function () {
                jQuery("#textfile_create_area").parent().parent().remove(),
                    y.ajax({ type: "GET", url: "ajax_calls.php?action=new_file_form" }).done(function (e) {
                        bootbox.dialog(
                            e,
                            [
                                { label: jQuery("#cancel").val(), class: "btn" },
                                {
                                    ...
                                    callback: function () {
                                        ...
                                        if (null !== e) {
                                            ...
                                            y.ajax({ type: "POST", url: "execute.php?action=create_file", data: { path: t, name: e, new_content: a } }).done(function (e) {
                                                "" != e &&
            ...
            jQuery(".new-folder").on("click", function () {
                bootbox.prompt(jQuery("#insert_folder_name").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (e) {
                    if (null !== e) {
                        ...
                        y.ajax({ type: "POST", url: "execute.php?action=create_folder", data: { path: a, name: e } }).done(function (e) {
                            e
            ...
            jQuery(".view-controller button").on("click", function () {
                ...
                jQuery(".view-controller button").removeClass("btn-inverse"),
                    ...
                    y.ajax({ url: "ajax_calls.php?action=view&type=" + e.attr("data-value") }).done(function (e) {
                        "" != e && bootbox.alert(e);
                    }),
                    void 0 !== jQuery("ul.grid")[0] && jQuery("ul.grid")[0] && (jQuery("ul.grid")[0].className = jQuery("ul.grid")[0].className.replace(/\blist-view.*?\b/g, "")),
                    void 0 !== jQuery(".sorter-container")[0] && jQuery(".sorter-container")[0] && (jQuery(".sorter-container")[0].className = jQuery(".sorter-container")[0].className.replace(/\blist-view.*?\b/g, ""));
                var a = e.attr("data-value");
                jQuery("#view").val(a),
                    jQuery("ul.grid").addClass("list-view" + a),
                    jQuery(".sorter-container").addClass("list-view" + a),
                    1 <= e.attr("data-value") ? p(14) : (jQuery("ul.grid li").css("width", 126), jQuery("ul.grid figure").css("width", 122)),
                    b();
            }),
            n.touch
                ? (jQuery("#help").show(), jQuery(".box:not(.no-effect)").swipe({ swipeLeft: v, swipeRight: v, threshold: 30 }))
            ...
            jQuery(".clear-clipboard-btn").on("click", function () {
                0 == jQuery(this).hasClass("disabled") &&
                    bootbox.confirm(jQuery("#lang_clear_clipboard_confirm").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (e) {
                        1 == e &&
                            y.ajax({ type: "POST", url: "ajax_calls.php?action=clear_clipboard", data: {} }).done(function (e) {
        ...
        if (
                    ...
                    bootbox.confirm(e.attr("data-confirm"), jQuery("#cancel").val(), jQuery("#ok").val(), function (e) {
                        if (1 == e) {
                            ...
                            (r = "delete_files"),
                                ...
                                null !== name &&
                                    ((name = Q(name)),
                                    y.ajax({ type: "POST", url: "execute.php?action=" + r, data: { path: i[0], paths: i, names: n } }).done(function (e) {
            ...
            r.on("mouseover", function () {
                0 == jQuery("#view").val() && !1 === jQuery("#main-item-container").hasClass("no-effect-slide") && jQuery(this).find(".box:not(.no-effect)").animate({ top: "-26px" }, { queue: !1, duration: 300 });
            }),
                r.on("mouseout", function () {
                    0 == jQuery("#view").val() && jQuery(this).find(".box:not(.no-effect)").animate({ top: "0px" }, { queue: !1, duration: 300 });
                });
        }
            ...
            jQuery("li.dir,li.back").droppable({
                ...
                drop: function (e, a) {
                    !(function (t, r) {
                        ...
                        t.parent().hide(100),
                            y
                                .ajax({ type: "POST", url: "ajax_calls.php?action=copy_cut", data: { path: e, sub_action: "cut" } })
                                .done(function (e) {
                                    var a;
                                    "" != e
                                        ? bootbox.alert(e)
                                        : ((a = void 0 !== r ? (r.hasClass("back-directory") ? r.find(".path").val() : r.closest("figure").attr("data-path")) : jQuery("#sub_folder").val() + jQuery("#fldr_value").val()),
                                          y.ajax({ type: "POST", url: "execute.php?action=paste_clipboard", data: { path: a } }).done(function (e) {
            ...
            if ((1 == o.length && (u = o[0]), "" != a)) {
                if (1 == jQuery("#crossdomain").val()) t.postMessage({ sender: "responsivefilemanager", url: u, field_id: a }, "*");
                    ...
                    jQuery("#" + a, t.document)
                        .val(u)
                        .trigger("change"),
                        0 == r ? "function" == typeof t.responsive_filemanager_callback && t.responsive_filemanager_callback(a) : "function" == typeof t[r] && t[r](a),
                        j();
            } else {
                for (var c = 0; c < o.length; c++) {
                    ...
                    -1 < y.inArray(f, ext_img)
                        ? (jQuery("#add_time_to_img").val() && (p = p + "?" + new Date().getTime()), (i += '<img src="' + p + '" alt="' + d + '" /> '))
                        : -1 < y.inArray(f, l)
                        ? (i += '<video controls source src="' + p + '" type="video/' + f + '">' + d + "</video> ")
                        : -1 < y.inArray(f, n)
                        ? ("mp3" == f && (f = "mpeg"), (i += '<audio controls src="' + p + '" type="audio/' + f + '">' + d + "</audio> "))
                        : (i += '<a href="' + p + '" title="' + d + '">' + d + "</a> ");
                }
                1 == jQuery("#crossdomain").val()
                    ? t.postMessage({ sender: "responsivefilemanager", url: u, field_id: null, html: i }, "*")
                    : parent.tinymce.majorVersion < 4
                    ? (parent.tinymce.activeEditor.execCommand("mceInsertContent", !1, i), parent.tinymce.activeEditor.windowManager.close(parent.tinymce.activeEditor.windowManager.params.mce_window_id))
        ...
        (apply_link = function (e, a) {
            ...
            (1 == i.length && (n = i[0]), "" != a)
                ? 1 == jQuery("#crossdomain").val()
                    ? t.postMessage({ sender: "responsivefilemanager", url: i[0], field_id: a }, "*")
                    : (jQuery("#" + a, t.document)
                          .val(n)
                          .trigger("change"),
                      0 == r ? "function" == typeof t.responsive_filemanager_callback && t.responsive_filemanager_callback(a) : "function" == typeof t[r] && t[r](a),
