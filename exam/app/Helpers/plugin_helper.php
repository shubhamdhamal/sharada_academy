...
if (!function_exists('get_plugin_meta_data')) {
    ...
    function get_plugin_meta_data($plugin_name = "") {
        ...
        preg_match('|Supports at most:(.*)$|mi', $plugin_index_file_contents, $supports_at_most);
        ...
        if (isset($supports_at_most[1])) {
            $plugin_info_array['supports_at_most'] = trim($supports_at_most[1]);
        }
...
if (!function_exists('is_unsupported_plugin')) {
    ...
    function is_unsupported_plugin($plugin_name) {
        ...
        if (get_array_value($plugin_info, "supports_at_most") && ($app_version > get_array_value($plugin_info, "supports_at_most"))) {
            $error = sprintf(app_lang("plugin_supports_at_most_error_message"), get_array_value($plugin_info, "supports_at_most"));
        }*/
