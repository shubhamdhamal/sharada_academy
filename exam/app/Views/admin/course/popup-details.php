                     ...
                     <table class="table table-bordered table-hover mg-b-0">
                        <tbody>
                           <tr>
                              ...
                              <td><?php echo get_column_value(TBL_COURSE,array('id'=>$id),'name'); ?></td>
                           </tr>
                           <?php $status = get_column_value(TBL_COURSE,array('id'=>$id),'is_active'); ?>
                           <tr>
                           ...
                           <tr>
                              ...
                              <td><?php echo get_crud_user_details(get_column_value(TBL_COURSE,array('id'=>$id),'created_by'),'name'); ?></td>
                           </tr>
                           <tr>
                              <th><?php echo translate('created_on') ?></th>
                              <td><?php echo utc_to_local_datetime(get_column_value(TBL_COURSE,array('id'=>$id),'created_on')); ?></td>
                           </tr>
                           <tr>
                              <th><?php echo translate('updated_by') ?></th>
                              <td><?php echo get_crud_user_details(get_column_value(TBL_COURSE,array('id'=>$id),'updated_by'),'name'); ?></td>
                           </tr>
                           <tr>
                              <th><?php echo translate('updated_on') ?></td>
                              <td><?php echo utc_to_local_datetime(get_column_value(TBL_COURSE,array('id'=>$id),'updated_on')); ?></td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
