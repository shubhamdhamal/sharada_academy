<div class="page-header">
    ...
    <div class="btn btn-list">
        <?php if(empty($permissions) || isset($permissions['languages']['edit'])){ ?>
            <a class="btn ripple popup-page btn-primary" href="<?php echo admin_site_url('languages/page/add-edit'); ?>"><i class="fe fe-plus-circle ml-2"></i> <?php echo translate('add_new') ?></a>
        <?php } ?>
    </div>
</div>
    ...
    $(document).ready(function () {
        $('.data-list-table').DataTable({
            ...
            "columns": [
                ...
                {"data": "slug", orderable: false, className: 'text-center'},
