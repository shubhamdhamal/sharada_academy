      ...
      <?php if (isset($slider) && !empty($slider)) { ?>
        <div class="container-fluid p-0">
          <div id="rev_slider_home_wrapper" class="rev_slider_wrapper" data-alias="news-gallery34"
            ...
            <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
              <ul>
              <?php $i=0; foreach ($slider as $key => $value) { $i++; ?>
                <li data-index="rs-<?php echo $i ?>" data-transition="fade" data-slotamount="default" data-easein="default"
                  data-easeout="default" data-masterspeed="default" data-thumb="<?php echo uploads_url($value->image); ?>"
                  data-rotate="0" data-fstransition="fade" data-saveperformance="off" data-title="Web Show"
                  data-description="">
                  <img src="<?php echo uploads_url($value->image); ?>" alt="" data-bgposition="center center" data-bgfit="cover"
                    data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                  <div
                    class="tp-caption tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0 "
                    id="slide-<?php echo $i ?>-layer-1" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                    ...
                    style="z-index: 5;background-color:rgba(0, 0, 0, 0);border-color:rgba(0, 0, 0, 0);">
                  </div>
                  <div
                    class="tp-caption tp-resizeme rs-parallaxlevel-0 text-white text-uppercase font-roboto-slab font-weight-700"
                    id="slide-<?php echo $i ?>-layer-2" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                    ...
                    data-width="['700','650','600','420',320]" data-height="none" data-whitespace="normal"
                    ...
                    style="z-index: 5; white-space: nowrap; font-weight:700;"> <span
                      class="text-theme-colored2"></span> 
                  </div>
                  <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" id="slide-<?php echo $i ?>-layer-3"
                  ...
                  <div class="tp-caption rs-parallaxlevel-0" id="slide-<?php echo $i ?>-layer-4"
                    data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                    ...
                    style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a
                      class="  btn-flat text-white font-weight-600 pl-30 pr-30 mr-15"
                      href="#"></a>
                      <a class=" btn-transparent btn-bordered  btn-flat font-weight-600 pl-30 pr-30"
                      href="#"></a>
                  </div>
                </li>
                <?php } ?>
            ...
            <div class="section-content">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p>We provide best education under Integrated Course for th, th th ScienceCollege coaching under one roof. Std.th th Science Board and JEE, NEET, MHT-CET Entrance Exams. st to th Regular batches for Mathematics, Science, English, SST, Marathi, English, Semi English Medium for SSC/CBSE board</p>
                        <a href="<?php echo home_site_url('about-us'); ?>" class="btn btn-colored btn-theme-colored2 text-white btn-lg pl-40 pr-40 mt-15">Read More</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- <div class="panel-group accordion-stylished-left-border accordion-icon-filled accordion-no-border accordion-icon-left accordion-icon-filled-theme-colored2" id="accordion6" role="tablist" aria-multiselectable="true"> -->
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headin1">
                                        <h6 class="panel-title"><span class="pe-7s-check"></span>
                                            Module wise study matenal for each topic for each subject
                                        </h6>
                                    </div>
                                </div>
                                <div class="panel panel-default">
