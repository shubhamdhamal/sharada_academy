        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.status) {
                    ...
                    if (typeof data.is_contact != "undefined") {
                        if (data.status) {
                            jQuery(".contact_result").html(data.message);
                        } else {
                            jQuery(".contact_result").html(data.message);
                        }
                    }
                    if (typeof data.is_inquiry != "undefined") {
                        if (data.status) {
                            jQuery(".inquiry_result").html(data.message);
                        } else {
                            jQuery(".inquiry_result").html(data.message);
                        }
                    }
                    if (typeof data.is_course_enquiry != "undefined") {
                        if (data.status) {
                            jQuery(".course_result").html(data.message);
                        } else {
                            jQuery(".course_result").html(data.message);
                        }
                    }
