;(function( $, window, document, undefined ) {
  ...
  'use strict';
    ...
    var defaults = {drag_disabled: false,text_title:true,text_content:true,is_preview:false};
    ...
    $.extend( Plugin.prototype, {
      ...
      renderMarkup: function() {
        ...
        var $left_box_wrapper =             $('<div class="image-marker-container-left image-marker-container__box image-marker-container__box--left"></div>');
        var $left_box =  this.$left_box =   $('<div class="image-marker-container__box__content"></div>');
        var $right_box_wrapper =            $('<div class="image-marker-container-right image-marker-container__box image-marker-container__box--right"></div>');
        var $right_box = this.$right_box =  $('<div class="image-marker-container__box__content"></div>');
        var $image_box =                    $('<div class="image-marker-container-image image-marker-container__box image-marker-container__box--image"></div>');
      ...
      preview: function() {
        if($(".image-marker-container-left").length){
            $(".image-marker-container-left ").remove();
        }
        if($(".image-marker-container-right").length){
            $(".image-marker-container-right").remove();
        }
        if($(".image-marker-container-image").length){
            $(".image-marker-container-image").css({"left":"0","right":"0"});
        }
      }
    });
