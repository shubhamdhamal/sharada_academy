<div class="page-header">
    ...
    <div class="btn btn-list">
        <?php if(empty($permissions) || isset($permissions['event']['edit'])){ ?>
            <a class="btn ripple btn-secondary" href="<?php echo admin_site_url('event/order'); ?>"><i class="fe fe-move ml-2"></i> <?php echo translate('order') ?></a>
            <a class="btn ripple popup-page btn-primary" href="<?php echo admin_site_url('event/page/add-edit'); ?>"><i class="fe fe-plus-circle ml-2"></i> <?php echo translate('add_new') ?></a>
        <?php } ?>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        $('.data-list-table').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo admin_site_url('event/crud'); ?>",
                "dataType": "json",
                "type": "POST",
                "data": {action : 'list'},
            ...
            "columns": [
                ...
                {"data": "date", orderable: false, className: 'text-center'},
