...
<div class="row sidemenu-height">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card custom-card">
            <div class="card-body">
                <?php echo form_open(admin_site_url('course/crud'), array('class'=>'data-parsley-validate', 'method'=>'post','data-block_form'=>'true','enctype'=>'multipart/form-data','data-multipart'=>'true'), array('action'=>$page_action)); ?>
                    <div class="row">
                        <div class="col-12 col-sm-12 text-center">
                            <ul class="list-group sortable">
                                <?php if(isset($course) && !empty($course)){ foreach ($course as $key => $value) { ?>
                                    <li class="list-group-item d-flex align-items-center draggable">
                                        ...
                                        <div>
                                            <?php if($value->description!=''){ ?>
                                                <span class="d-block tx-11 text-muted"><?php echo $value->description ?></span>
                                            <?php } ?>
