...
<div class="row sidemenu-height">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card custom-card">
            <div class="card-body">
                <iframe src="<?php echo base_url('filemanager/dialog.php'); ?>" title="<?php echo isset($page_title) && $page_title != '' ? translate($page_title) : '' ?>" style="width: 100%;height: 400px;"></iframe>
