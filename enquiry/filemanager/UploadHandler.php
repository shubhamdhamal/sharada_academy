...
class UploadHandler
{
    ...
    protected function upcount_name_callback($matches) {
        ...
        $cs = $this->options['config']['convert_spaces'] ? $this->options['config']['replace_with'] : ' ';
        return $cs.'('.$index.')'.$ext;
    }
    ...
    protected function get_unique_filename($file_path, $name, $size, $type, $error,
        ...
        $cr = isset($content_range[1]) ? $content_range[1] : 0;
        $uploaded_bytes = $this->fix_integer_overflow((int)$cr);
