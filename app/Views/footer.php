            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="widget dark">
                        <img class="mt-5 mb-20" alt="" src="<?php echo uploads_url('footer-logo.png'); ?>">
                        <a href="<?php echo uploads_url('brochure.pdf'); ?>" download="Sharada Academy Brochure.pdf" class="btn btn-colored btn-theme-colored2 text-white btn-lg btn-block">Download Brochure</a>
                ...
                <div class="col-sm-6 col-md-3 "><div class="widget dark ">
                  ...
                  <ul class="list-inline mt-5">
                    <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-theme-colored2 mr-5 "></i> <a class="text-white" href="tel: +91 9271585443">+91 9271585443</a> / <a class="text-white" href="tel: +91 9975711852">+91 9975711852</a> </li>
                    <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-theme-colored2 mr-5 "></i> <a class="text-white" href="tel: +91 9284328933">+91 9284328933</a> / <a class="text-white" href="tel: +91 9404051530">+91 9404051530</a> </li>
                    ...
                    <ul class="styled-icons icon-sm icon-bordered icon-circled clearfix mt-10">
                        <li><a href="https://www.facebook.com/sharadaacademybaramati" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://www.instagram.com/sharadaacademy?utm_source=qr&igshid=YzU1NGVlODEzOA==" target="_blank"><i class="fa fa-instagram"></i></a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <div class="widget no-border m-0">
                            ...
                            <?php if($page_name!=''){ ?> 
                              <li><a  class="text-white"href="<?php echo home_site_url('return-refund-and-cancellation-policy') ?>"><?php echo translate('refund_policy') ?></li><li>|</li>
                            <?php } ?> 
...
<?php if(app_setting('popup_status')=='on' && current_url()==home_site_url()){?>
    <div class="modal fade popup-modal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <img class="img-fluid" src="<?php echo app_setting('popup_banner'); ?>" />
            </div>
        </div>
    </div>
<?php } ?>
