            ...
            <div class="section-content">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p>'SHARADA ACADEMY' is an ideal path finder for aspirants who aim to join the elite community called IITians and/or doctors. With teaching experience over several years, we have developed the expertise and methodologies, required to generate confidence among students and parents.
                            We constantly update our methods of teaching by introducing new methods of explanations. This allows the students to keep themselves abreast with the latest developments and methodologies to face the challenges posed in IIT-JEE/NEET. </p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><span class="pe-7s-check"></span>To nurture a friendly environment to make the students competent in their study.</p>
                        <p><span class="pe-7s-check"></span>To promote the idea that there is no shortcut for success. Every subject will be enjoyable once studied with interest and clarity.</p>
                        <p><span class="pe-7s-check"></span>To enhance students' soft skills(Communication skills in English, presentation...) to make the students excellent in academic career.</p>
                    ...
                    <div class="col-md-6 ">
                        <img class="img-fullwidth maxwidth500 " src="<?php echo home_assets_url('images/mission.png'); ?>" alt="" style="margin-top: 100px;">
                    </div>
                </div>
            </div>
        </div>
...
<section class="parallax divider layer-overlay overlay-theme-colored-9" data-bg-img="<?php echo home_assets_url('images/tour.jpg'); ?>" data-parallax-ratio="0.4">
    <div class="container pt-60 pb-90">
        <div class="row">
            <div class="col-md-12 text-center">
                <h2 class="text-white text-uppercase font-46 font-weight-700 mb-10">Let's have a <span class="text-theme-colored2">Campus</span> Tour</h2>
                <p class="font-16 text-white mb-20">We provides always our best industrial solution for our student always try to <br> achieve our student's trust and satisfaction. </p>
