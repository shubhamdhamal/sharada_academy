...
<form id="export_form">
    ...
    <input type="hidden" name="type" value="exam_registration">
</form>
...
<script>
    ...
    function get_data(){
        <?php
            $data_srt = '"action":"exam_register_list"';
        ...
        $('.data-list-table').DataTable({
            ...
            "columns": [
                ...
                {"data": "crash_course", orderable: false, className: 'text-center'},
                {"data": "address", orderable: false, className: 'text-center'},
