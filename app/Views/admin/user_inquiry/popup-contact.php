                     ...
                     <table class="table table-bordered table-hover mg-b-0">
                        <tbody>
                           <tr>
                              ...
                              <td><?php echo get_column_value(TBL_CONTACT,array('id'=>$id),'name'); ?></td>
                           </tr>
                           <tr>
                              <th><?php echo translate('email'); ?></th>
                              <td><?php echo get_column_value(TBL_CONTACT,array('id'=>$id),'email'); ?></td>
                           </tr>
                           <tr>
                              <th><?php echo translate('subject'); ?></th>
                              <td><?php echo get_column_value(TBL_CONTACT,array('id'=>$id),'subject'); ?></td>
                           </tr>
                          
                           <tr>
                              <th><?php echo translate('phone_no'); ?></th>
                              <td><?php echo get_column_value(TBL_CONTACT,array('id'=>$id),'phone'); ?></td>
                           </tr>
                          
                           <tr>
                              <th><?php echo translate('message'); ?></th>
                              <td><?php echo get_column_value(TBL_CONTACT,array('id'=>$id),'message'); ?></td>
                           </tr>
                           <tr>
                              <th><?php echo translate('created_on') ?></th>
                              <td><?php echo utc_to_local_datetime(get_column_value(TBL_CONTACT,array('id'=>$id),'created_on')); ?></td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
