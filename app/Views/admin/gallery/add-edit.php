...
<div class="row sidemenu-height">
   <div class="col-lg-12">
      <div class="card custom-card">
         <div class="card-body">
            <?php echo form_open(admin_site_url('gallery/crud'), array('class' => 'data-parsley-validate', 'method' => 'post', 'data-block_form' => 'true', 'enctype' => 'multipart/form-data', 'data-multipart' => 'true'), array('action' => $page_action, 'id' => encode_string($id))); ?>
            <div class="row">
               <div class="col-12 col-sm-3">
                  <div class="form-group">
                     <?php echo app_file_manager('image', 'image', 1, get_column_value(TBL_GALLERY, array('id' => $id), 'image', 'default.png')); ?>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-12 col-sm-9">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="name" placeholder="<?php echo translate('name'); ?>" tabindex="2" value="<?php echo get_column_value(TBL_GALLERY, array('id' => $id), 'name'); ?>" autocomplete="off" required />
                        </div>
                     </div>
                     <?php
                     $status_list = array(
                     ...
                     <div class="col-12 col-sm-3">
                        <div class="form-group">
                           ...
                           <?php echo form_dropdown('is_active', $status_list, get_column_value(TBL_GALLERY, array('id' => $id), 'is_active'), array('class' => 'form-control select2', 'required' => true, 'tabindex' => '3', 'data-parsley-errors-container' => "#error_status")); ?>
                     ...
                     <div class="col-12 col-sm-6">
                        <div class="form-group">
                           ...
                           <textarea class="form-control" name="short_description" placeholder="<?php echo translate('short_description'); ?>" tabindex="4" required><?php echo get_column_value(TBL_GALLERY, array('id' => $id), 'short_description'); ?></textarea>
                        </div>
                     </div>
                     <div class="col-12 col-sm-6">
                        <div class="form-group">
                           <label><?php echo translate('SEO_description'); ?></label>
                           <textarea class="form-control" name="seo_description" placeholder="<?php echo translate('SEO_description'); ?>" tabindex="5"><?php echo get_column_value(TBL_GALLERY, array('id' => $id), 'seo_description'); ?></textarea>
                        </div>
                     </div>
                     <div class="col-12 col-sm-8">
                        <div class="form-group">
                           <label><?php echo translate('SEO_keywords'); ?></label>
                           <input type="text" data-role="tagsinput" class="form-control" name="seo_keywords" placeholder="<?php echo translate('SEO_keywords'); ?>" value="<?php echo get_column_value(TBL_GALLERY, array('id' => $id), 'seo_keywords'); ?>" tabindex="6" />
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="row image-sortable images_row">
               <?php $i = 0;
               $images = json_decode(get_column_value(TBL_GALLERY, array('id' => $id), 'images')); ?>
               <?php if (!empty($images)) {
