               ...
               <div class="col-md-12">
                  <div class="table-responsive">
                     <table class="table table-bordered table-hover mg-b-0">
                        <tbody>
                           <tr>
                              <td colspan="2"><?php echo '<img alt="'.get_column_value(TBL_TESTIMONIAL,array('id'=>$id),'name').'" class="radius image-delay" src="'.uploads_url('loader.gif').'" data-src="'.uploads_url(get_column_value(TBL_TESTIMONIAL,array('id'=>$id),'image',uploads_url('default.png'))).'">'; ?></td>
                           </tr>
                           <tr>
                              <th><?php echo translate('name'); ?></th>
                              <td><?php echo get_column_value(TBL_TESTIMONIAL,array('id'=>$id),'name'); ?></td>
                           </tr>
                           <tr>
                              <th><?php echo translate('short_description') ?></th>
                              <td><?php echo get_column_value(TBL_TESTIMONIAL,array('id'=>$id),'short_description'); ?></td>
                           </tr>
                           <?php $i=0; $images = json_decode(get_column_value(TBL_TESTIMONIAL,array('id'=>$id),'images')); ?>
                           <?php if(!empty($images)){ ?>
                              <tr>
                                 <td colspan="2">
                           ...
                           <?php } ?>
                           <?php $status = get_column_value(TBL_TESTIMONIAL,array('id'=>$id),'is_active'); ?>
                           <tr>
                           ...
                           <tr>
                              ...
                              <td><?php echo get_crud_user_details(get_column_value(TBL_TESTIMONIAL,array('id'=>$id),'created_by'),'name'); ?></td>
                           </tr>
                           <tr>
                              <th><?php echo translate('created_on') ?></th>
                              <td><?php echo utc_to_local_datetime(get_column_value(TBL_TESTIMONIAL,array('id'=>$id),'created_on')); ?></td>
                           </tr>
                           <tr>
                              <th><?php echo translate('updated_by') ?></th>
                              <td><?php echo get_crud_user_details(get_column_value(TBL_TESTIMONIAL,array('id'=>$id),'updated_by'),'name'); ?></td>
                           </tr>
                           <tr>
                              <th><?php echo translate('updated_on') ?></td>
                              <td><?php echo utc_to_local_datetime(get_column_value(TBL_TESTIMONIAL,array('id'=>$id),'updated_on')); ?></td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
