<div class="page-header">
	<div>
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="<?php echo admin_site_url('announcements'); ?>"><?php echo translate('announcements'); ?></a></li>
			<li class="breadcrumb-item active" aria-current="page"><?php echo isset($page_title) && $page_title != '' ? translate($page_title) : '' ?></li>
		</ol>
	</div>
    <div class="btn btn-list">
    <a class="btn ripple btn-primary" href="<?php echo admin_site_url('announcements'); ?>"><i class="fe fe-list ml-2"></i> <?php echo translate('list') ?></a>
    </div>
</div>
<div class="row sidemenu-height">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card custom-card">
            <div class="card-body">
                <?php echo form_open(admin_site_url('announcements/crud'), array('class'=>'data-parsley-validate', 'method'=>'post','data-block_form'=>'true','enctype'=>'multipart/form-data','data-multipart'=>'true'), array('action'=>$page_action)); ?>
                    <div class="row">
                        <div class="col-12 col-sm-12 text-center">
                            <ul class="list-group sortable">
                                <?php if(isset($announcements) && !empty($announcements)){ foreach ($announcements as $key => $value) { ?>
                                    <li class="list-group-item d-flex align-items-center draggable">
                                        ...
                                        <div>
                                            ...
                                            <?php /*<span class="d-block tx-11 text-muted"></span>*/ ?>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 text-center">
                            ...
                            <a class="btn ripple btn-secondary" href="<?php echo admin_site_url('announcements') ?>"><?php echo translate('close'); ?></a>
                        </div>
                    </div>
                <?php echo form_close(); ?>
			</div>
