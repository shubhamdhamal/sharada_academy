<div class="page-header">
    ...
    <div class="btn btn-list">
        <?php if(empty($permissions) || isset($permissions['role']['edit'])){ ?>
            <a class="btn ripple popup-page btn-primary" href="<?php echo admin_site_url('role/page/add-edit'); ?>"><i class="fe fe-plus-circle ml-2"></i> <?php echo translate('add_new') ?></a>
        <?php } ?>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        $('.data-list-table').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo admin_site_url('role/crud'); ?>",
                "dataType": "json",
                "type": "POST",
                "data": {action : 'list'},
