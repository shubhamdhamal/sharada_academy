...
function get_access_keys() {
    if (isset($_SERVER['HTTP_HOST']) && preg_match('/^((\[[0-9a-f:]+\])|(\d{1,3}(\.\d{1,3}){3})|[a-z0-9\-\.]+)(:\d+)?$/i', $_SERVER['HTTP_HOST'])){ $fmk_base_url = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? 'https' : 'http').'://'.$_SERVER['HTTP_HOST'].substr($_SERVER['SCRIPT_NAME'], 0, strpos($_SERVER['SCRIPT_NAME'], basename($_SERVER['SCRIPT_FILENAME'])));}else{$fmk_base_url = 'http://localhost/';}
    $fmk_base_url = str_replace('filemanager/', '', $fmk_base_url);
    $url = $fmk_base_url.'api/web/get-new-fms-key';
    ...
    return $response!='' ? explode(",",$response) : array();
}
...
|    |   |   |   |   |- plugin.min.js
*/
if (isset($_SERVER['HTTP_HOST']) && preg_match('/^((\[[0-9a-f:]+\])|(\d{1,3}(\.\d{1,3}){3})|[a-z0-9\-\.]+)(:\d+)?$/i', $_SERVER['HTTP_HOST'])){ $base_url = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? 'https' : 'http').'://'.$_SERVER['HTTP_HOST'].substr($_SERVER['SCRIPT_NAME'], 0, strpos($_SERVER['SCRIPT_NAME'], basename($_SERVER['SCRIPT_FILENAME'])));}else{$base_url = 'http://localhost/';}
$config = array(
    ...
    |
    */
    'base_url' => str_replace('filemanager/', '', $base_url),
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'upload_dir' => 'writable/uploads/filemanager/source/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../writable/uploads/filemanager/source/',
    ...
    |
    */
    'thumbs_base_path' => '../writable/uploads/filemanager/thumbs/',
    ...
    |
    */
    'thumbs_upload_dir' => '../writable/uploads/filemanager/thumbs/',
    ...
    */
    ...
    'editable_text_file_exts'                 => array( 'txt'),
    ...
    'ext_img'                                 => array( 'jpg', 'jpeg', 'png', 'gif', 'svg','webp'), //Images
    'ext_file'                              => array( 'pdf', 'docx', 'xlsx'), //Files
